...
|---|---|
| Public learner ID · المعرّف العام | `[Maitha-t]` |
...
| Day 3 / `C29_EXPORT_SAFETY_CHECK` · اليوم الثالث | `PASS` | Upload only after `FINAL_EXPORT_CREATED`. · لا ترفع إلا بعد ظهور `FINAL_EXPORT_CREATED`. |
