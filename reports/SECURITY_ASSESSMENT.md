...
- New synthetic case | الحالة الاصطناعية الجديدة: `{"asset": "create_refund_request", "case_id": "L-SEC-09", "control": "server_ownership_and_approval_gate", "expected_flag": "prompt_injection", "payload_length": 107}`
...
- Assessment run ID | معرّف التقييم: `run-2d1aac7c63db4f86`
